    ...
    <div className='flex gap-10'>
        ...
        <div className=''>
            ...
            <div className='flex items-center gap-5 my-4 '>
                ...
                <input className='w-5 text-center text-4xl font-bold' type="text" value={quantity}></input>
                <div onClick={increment} className='text-4xl cursor-pointer'>+</div>    
            </div>      

            <div onClick={addBasket} className='my-4 border w-[200 px] text-2xl rounded-md bg-gray-200 cursor-pointer h-16  flex items-center justify-center'>Sepete Ekle</div>    
        </div>
    </div>
  )
}
